package com.Ali.EcommerceApp.models;
...
public class ProductDTO {
    ...
    public @Size(min = 10, message = "The description should be at least 10 characters") String getDescription() {
        return description;
    }

    public void setDescription(@Size(min = 10, message = "The description should be at least 10 characters") String description) {
